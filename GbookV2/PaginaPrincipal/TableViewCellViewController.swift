...
class TableViewCellViewController: UIViewController {
    ...
    @IBOutlet weak var buttonGbookear: UIButton!
    ...
    func borderColor(){
        ...
        buttonGbookear.layer.shadowColor = UIColor.black.cgColor
        buttonGbookear.layer.shadowOffset = CGSize(width: 5, height: 5)
        buttonGbookear.layer.shadowRadius = 5
        buttonGbookear.layer.shadowOpacity = 1.0
        0
        buttonGbookear.layer.cornerRadius = 12
